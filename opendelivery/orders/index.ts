...
export interface GetDeliveryOrderDetailsResponse extends OrderDetails {
  type: 'DELIVERY';
  delivery: OrderDelivery;
}

export interface GetTakeOutOrderDetailsResponse extends OrderDetails {
  type: 'TAKEOUT';
  takeout: OrderTakeout;
}

export interface GetIndoorOrderDetailsResponse extends OrderDetails {
  type: 'INDOOR';
  indoor: OrderIndoor;
}
